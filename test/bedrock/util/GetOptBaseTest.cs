...
namespace test.bedrock.util
{
    ...
    {
        [CommandLine("nologo", Description = "Command line argument for NUnit.")] public bool nologo = false;
        [CommandLine("f", Description = "Foo or not")] public bool foo = false;
        [CommandLine(Description = "What's in a bar?")] public string bar = "one";
        [CommandLine("private")] private string m_baz = "default";
        ...
        public int iNone;
        [CommandLine("some", Description = "Integer param")] public int iSome = 0;
        ...
        [CommandLine] public bool a = false;
        [CommandLine] public bool b = true;
        [CommandLine] public bool c = false;
        [CommandLine] public bool d = true;
        [CommandLine] public string e = null;

        [CommandLine] public TestOptEnum fb = TestOptEnum.FOO;

        [CommandLine] public string assembly;
    ...
    {
        [CommandLine("bad", "A required parameter", true)] public string Bad = "Bad";
    ...
    {
        [CommandLine(Required = true)] public string Req = null;
    ...
    {
        [CommandLine] public string test = null;
    }
